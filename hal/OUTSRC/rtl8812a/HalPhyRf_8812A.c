...
void _IQK_BackupMacBB_8812A(
	IN PDM_ODM_T	pDM_Odm,
	IN uint32_t		*MACBB_backup,
	IN uint32_t		*Backup_MACBB_REG,
	IN uint32_t		MACBB_NUM
	)
{
	uint32_t i;
	ODM_SetBBReg(pDM_Odm, 0x82c, BIT(31), 0x0); // [31] = 0 --> Page C
...
void _IQK_BackupRF_8812A(
	IN PDM_ODM_T	pDM_Odm,
	IN uint32_t		*RFA_backup,
	IN uint32_t		*RFB_backup,
	IN uint32_t		*Backup_RF_REG,
	IN uint32_t		RF_NUM
	)
{
...
void _IQK_BackupAFE_8812A(
	IN PDM_ODM_T		pDM_Odm,
	IN uint32_t		*AFE_backup,
	IN uint32_t		*Backup_AFE_REG,
	IN uint32_t		AFE_NUM
	)
{
	uint32_t i;
...
void _IQK_RestoreRF_8812A(
	...
	IN ODM_RF_RADIO_PATH_E 	Path,
	IN uint32_t			*Backup_RF_REG,
	IN uint32_t 			*RF_backup,
	IN uint32_t			RF_REG_NUM
	)
{
	uint32_t i;
	...
	)
{
	...
	uint32_t Power_GL;
	uint16_t Scaler[]={0x4000, 0x41db, 0x43c7, 0x45c3, 0x47cf, 0x49ec, 0x4c19, 0x4e46, 0x5093,0x52f2,  //10
