	...
	u8 RFPath, u8 Rate)
{
	...
	if (RFPath == RF_PATH_A) {
		...
		case MGN_1M:    
			...
			break;
		case MGN_2M:    
			rtl_set_bbreg(Adapter, rTxAGC_A_CCK11_CCK1_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_5_5M:  
			rtl_set_bbreg(Adapter, rTxAGC_A_CCK11_CCK1_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_11M:   
			rtl_set_bbreg(Adapter, rTxAGC_A_CCK11_CCK1_JAguar, bMaskByte3, PowerIndex); 
			break;

		case MGN_6M:    
			rtl_set_bbreg(Adapter, rTxAGC_A_Ofdm18_Ofdm6_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_9M:    
			rtl_set_bbreg(Adapter, rTxAGC_A_Ofdm18_Ofdm6_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_12M:   
			rtl_set_bbreg(Adapter, rTxAGC_A_Ofdm18_Ofdm6_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_18M:   
			rtl_set_bbreg(Adapter, rTxAGC_A_Ofdm18_Ofdm6_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_24M:   
			rtl_set_bbreg(Adapter, rTxAGC_A_Ofdm54_Ofdm24_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_36M:   
			rtl_set_bbreg(Adapter, rTxAGC_A_Ofdm54_Ofdm24_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_48M:   
			rtl_set_bbreg(Adapter, rTxAGC_A_Ofdm54_Ofdm24_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_54M:   
			rtl_set_bbreg(Adapter, rTxAGC_A_Ofdm54_Ofdm24_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_MCS0:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS3_MCS0_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_MCS1:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS3_MCS0_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_MCS2:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS3_MCS0_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_MCS3:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS3_MCS0_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_MCS4:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS7_MCS4_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_MCS5:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS7_MCS4_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_MCS6:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS7_MCS4_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_MCS7:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS7_MCS4_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_MCS8:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS11_MCS8_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_MCS9:  
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS11_MCS8_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_MCS10: 
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS11_MCS8_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_MCS11: 
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS11_MCS8_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_MCS12: 
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS15_MCS12_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_MCS13: 
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS15_MCS12_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_MCS14: 
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS15_MCS12_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_MCS15: 
			rtl_set_bbreg(Adapter, rTxAGC_A_MCS15_MCS12_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_VHT1SS_MCS0: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss1Index3_Nss1Index0_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_VHT1SS_MCS1: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss1Index3_Nss1Index0_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_VHT1SS_MCS2: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss1Index3_Nss1Index0_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_VHT1SS_MCS3: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss1Index3_Nss1Index0_JAguar, bMaskByte3, PowerIndex); 
			break;
		...
		case MGN_VHT1SS_MCS8: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index1_Nss1Index8_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_VHT1SS_MCS9: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index1_Nss1Index8_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS0: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index1_Nss1Index8_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS1: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index1_Nss1Index8_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_VHT2SS_MCS2: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index5_Nss2Index2_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS3: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index5_Nss2Index2_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS4: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index5_Nss2Index2_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS5: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index5_Nss2Index2_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_VHT2SS_MCS6: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index9_Nss2Index6_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS7: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index9_Nss2Index6_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS8: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index9_Nss2Index6_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS9: 
			rtl_set_bbreg(Adapter, rTxAGC_A_Nss2Index9_Nss2Index6_JAguar, bMaskByte3, PowerIndex); 
			break;
		...
		case MGN_6M:    
			rtl_set_bbreg(Adapter, rTxAGC_B_Ofdm18_Ofdm6_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_9M:    
			rtl_set_bbreg(Adapter, rTxAGC_B_Ofdm18_Ofdm6_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_12M:   
			rtl_set_bbreg(Adapter, rTxAGC_B_Ofdm18_Ofdm6_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_18M:   
			rtl_set_bbreg(Adapter, rTxAGC_B_Ofdm18_Ofdm6_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_24M:   
			rtl_set_bbreg(Adapter, rTxAGC_B_Ofdm54_Ofdm24_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_36M:   
			rtl_set_bbreg(Adapter, rTxAGC_B_Ofdm54_Ofdm24_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_48M:   
			rtl_set_bbreg(Adapter, rTxAGC_B_Ofdm54_Ofdm24_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_54M:   
			rtl_set_bbreg(Adapter, rTxAGC_B_Ofdm54_Ofdm24_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_MCS0:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS3_MCS0_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_MCS1:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS3_MCS0_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_MCS2:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS3_MCS0_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_MCS3:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS3_MCS0_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_MCS4:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS7_MCS4_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_MCS5:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS7_MCS4_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_MCS6:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS7_MCS4_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_MCS7:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS7_MCS4_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_MCS8:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS11_MCS8_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_MCS9:  
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS11_MCS8_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_MCS10: 
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS11_MCS8_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_MCS11: 
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS11_MCS8_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_MCS12: 
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS15_MCS12_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_MCS13: 
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS15_MCS12_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_MCS14: 
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS15_MCS12_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_MCS15: 
			rtl_set_bbreg(Adapter, rTxAGC_B_MCS15_MCS12_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_VHT1SS_MCS0: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss1Index3_Nss1Index0_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_VHT1SS_MCS1: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss1Index3_Nss1Index0_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_VHT1SS_MCS2: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss1Index3_Nss1Index0_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_VHT1SS_MCS3: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss1Index3_Nss1Index0_JAguar, bMaskByte3, PowerIndex); 
			break;
		...
		case MGN_VHT1SS_MCS8: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index1_Nss1Index8_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_VHT1SS_MCS9: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index1_Nss1Index8_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS0: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index1_Nss1Index8_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS1: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index1_Nss1Index8_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_VHT2SS_MCS2: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index5_Nss2Index2_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS3: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index5_Nss2Index2_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS4: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index5_Nss2Index2_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS5: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index5_Nss2Index2_JAguar, bMaskByte3, PowerIndex); 
			break;
		
		case MGN_VHT2SS_MCS6: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index9_Nss2Index6_JAguar, bMaskByte0, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS7: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index9_Nss2Index6_JAguar, bMaskByte1, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS8: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index9_Nss2Index6_JAguar, bMaskByte2, PowerIndex); 
			break;
		case MGN_VHT2SS_MCS9: 
			rtl_set_bbreg(Adapter, rTxAGC_B_Nss2Index9_Nss2Index6_JAguar, bMaskByte3, PowerIndex); 
			break;
