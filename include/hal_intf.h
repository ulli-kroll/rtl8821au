...
u32	rtw_hal_read_bbreg(struct rtl_priv *padapter, u32 RegAddr, u32 BitMask);
void	rtw_hal_write_bbreg(struct rtl_priv *padapter, u32 RegAddr, u32 BitMask, u32 Data);
