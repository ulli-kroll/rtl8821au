...
extern int rtw_recv_indicatepkt(struct rtl_priv *adapter, struct recv_frame *precv_frame);
...
int rtw_os_alloc_recvframe(struct rtl_priv *padapter, struct recv_frame *precvframe, u8 *pdata, struct sk_buff *pskb);
