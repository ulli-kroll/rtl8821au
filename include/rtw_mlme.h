...
void rtw_set_roaming(_adapter *adapter, uint8_t to_roaming);
uint8_t rtw_to_roaming(_adapter *adapter);
#else
...
void rtw_proxim_send_packet(_adapter *padapter,uint8_t *pbuf,u16 len,uint8_t hw_rate);
