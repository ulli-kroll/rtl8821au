...
extern void rtw_os_pkt_complete(struct rtl_priv *padapter, struct sk_buff *pkt);
extern void rtw_os_xmit_complete(struct rtl_priv *padapter, struct xmit_frame *pxframe);
