...
#ifndef __RTL8821AU_PWRSEQ_H__
#define __RTL8821AU_PWRSEQ_H__
...
#define RTL8821A_TRANS_CARDEMU_TO_ACT 														\
	...
	{0x0010, PWR_CUT_A_MSK , PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT(6) , BIT(6) },/* 0x10[6]=1 ; MP·s¼W¹ï©ó0x2Cªº±±¨îÅv¡A¶·§â0x10[6]³]¬°1¤~¯àÅýWLAN±±¨î */ \
